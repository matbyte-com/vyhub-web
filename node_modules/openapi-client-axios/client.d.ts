 ...
 */
export type OpenAPIClient<OperationMethods = UnknownOperationMethods, PathsDictionary = UnknownPathsDictionary> = AxiosInstance & OperationMethods & {
...
export declare class OpenAPIClientAxios {
    ...
    constructor(opts: {
        ...
        transformOperationMethod?: (operationMethod: UnknownOperationMethod, operationToTransform: Operation) => UnknownOperationMethod;
    });
    /**
     ...
     */
    registerRunner(runner: Runner, operationId?: string): void;
    private getRunner;
    /**
