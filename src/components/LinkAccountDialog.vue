<template>
  <div>
    ...
    <Dialog
      v-model="authReqDialog"
      icon="mdi-account-key"
      :title="authDialogType"
    ...
    >
      <div class="text-center mt-2">
        ...
        <div
          v-if="authCommand != null"
          class="mt-2"
        >
          <v-text-field
            readonly
            :model-value="authCommand"
        ...
        <div v-if="authDialogType === 'MINECRAFT'">
          ...
          <video
            ...
            playsinline
            loop
            src="https://cdn.vyhub.net/vyhub/minecraft-login.mp4"
          />
        </div>
      </div>
    </Dialog>
